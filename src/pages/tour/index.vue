...
<script>
	...
	export default{
		...
		mounted() {
			...
			this.local.localposition = common._getCookes('tourcity') || '北京'
			this.local.localareaId = common._getCookes('tourcityId') || '110000'
			this.city();
			this.tour();
		},
		methods:{
			toindex(){
				...
				tocity(areaId,val,index){
					...
					if(areaId== 110000 || areaId == 120000 || areaId == 500000 || areaId == 300000){
						...
						common._setCookie('tourcity', val)
						common._setCookie('tourcityId', areaId)
					}
